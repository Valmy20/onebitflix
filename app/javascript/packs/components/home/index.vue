...
<script>
    ...
    const featuredMovie = {
        ...
        description: 'Saber como criar e consumir APIs é fundamental para qualquer programador, então nessa pequena série nós vamos ver o que é essencial para cria uma usando Ruby on Rails.',
